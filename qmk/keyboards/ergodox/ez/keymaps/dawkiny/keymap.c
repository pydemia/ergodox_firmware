...
[NPAD] = KEYMAP(
       // left hand
       KC_ESC,   KC_F1,  KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,
       KC_TRNS, KC_TRNS, KC_AT,   M(2),    KC_LCBR, KC_RCBR, KC_TRNS,
       KC_TRNS, KC_HASH, KC_DLR,  KC_TRNS, KC_LPRN, KC_RPRN,
       KC_TRNS, KC_PERC, KC_CIRC, KC_TRNS, KC_LBRC, KC_RBRC, KC_TRNS,
       ...
       KC_TILD, KC_7,    KC_8,    KC_9,    KC_LBRC, KC_RBRC, KC_MINUS, 
                KC_4,    KC_5,    KC_6,    KC_LCBR, KC_RCBR, KC_ASTR,
